                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <h1>Elements</h1>
                            <NavLink to='/'>Home</NavLink> <span>|</span> <NavLink to='/Element'>elements</NavLink>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="section-top-border">
                        ...
                        <div className="row">
                            <div className="col-md-3">
                                <img src="assets/images/elements/d.jpg" alt className="img-fluid" />
                            </div>
                        ...
                        <div className="progress-table-wrap">
                            <div className="progress-table">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="assets/images/elements/f1.jpg" alt="flag" />Canada</div>
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="assets/images/elements/f2.jpg" alt="flag" />Canada</div>
                                    <div className="visit">645032</div>
                                    <div className="percentage">
                                        <div className="progress">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="assets/images/elements/f3.jpg" alt="flag" />Canada</div>
                                    <div className="visit">645032</div>
                                    <div className="percentage">
                                        <div className="progress">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="assets/images/elements/f4.jpg" alt="flag" />Canada</div>
                                    <div className="visit">645032</div>
                                    <div className="percentage">
                                        <div className="progress">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="assets/images/elements/f5.jpg" alt="flag" />Canada</div>
                                    <div className="visit">645032</div>
                                    <div className="percentage">
                                        <div className="progress">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="assets/images/elements/f6.jpg" alt="flag" />Canada</div>
                                    <div className="visit">645032</div>
                                    <div className="percentage">
                                        <div className="progress">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="assets/images/elements/f7.jpg" alt="flag" />Canada</div>
                                    <div className="visit">645032</div>
                                    <div className="percentage">
                                        <div className="progress">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="assets/images/elements/f8.jpg" alt="flag" />Canada</div>
                                    <div className="visit">645032</div>
                                    <div className="percentage">
                                        <div className="progress">
                    ...
                    <div className="section-top-border">
                        ...
                        <div className="row gallery-item">
                            <div className="col-md-4">
                                <a href="assets/images/elements/g1.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(assets/images/elements/g1.jpg)' }} /></a>
                            </div>
                            <div className="col-md-4">
                                <a href="assets/images/elements/g2.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(assets/images/elements/g2.jpg)' }} /></a>
                            </div>
                            <div className="col-md-4">
                                <a href="assets/images/elements/g3.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(assets/images/elements/g3.jpg)' }} /></a>
                            </div>
                            <div className="col-md-6">
                                <a href="assets/images/elements/g4.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(assets/images/elements/g4.jpg)' }} /></a>
                            </div>
                            <div className="col-md-6">
                                <a href="assets/images/elements/g5.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(assets/images/elements/g5.jpg)' }} /></a>
                            </div>
                            <div className="col-md-4">
                                <a href="assets/images/elements/g6.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(assets/images/elements/g6.jpg)' }} /></a>
                            </div>
                            <div className="col-md-4">
                                <a href="assets/images/elements/g7.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(assets/images/elements/g7.jpg)' }} /></a>
                            </div>
                            <div className="col-md-4">
                                <a href="assets/images/elements/g8.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(assets/images/elements/g8.jpg)' }} /></a>
                            </div>
                        </div>
                    </div>
                    <div className="section-top-border">
                        <div className="row">
                            <div className="col-lg-4 col-sm-6 typo-sec">
                                ...
                                <div className="typography">
                                    <h1 className="typo-list">h1</h1>
                                    <h2 className="typo-list">h2</h2>
